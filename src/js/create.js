function show() {
            ...
            function createQuest(){
                ...
                outputQuestion += '<h3>Spørsmål '+ number +'</h3>';
                outputQuestion += '<form name="choose">';
                outputQuestion += '<textarea rows="1" cols="30" class="question-title" id="question'+ number +'" name="text" placeholder="Spørsmål"></textarea>';
                outputQuestion += '<div class="choose-type">';
                outputQuestion += '<p>Svartype';
                outputQuestion += '<select id="sel' + number + '" name="' + number + '" onchange="selectChosen(name)">';
                outputQuestion += '<option id="' + number + '" value="TEXT">Tekst</option>';
                outputQuestion += '<option id="' + number + '" value="SLIDER">Rating</option>';
                outputQuestion += '<option id="' + number + '" value="COMMENT">Ja/nei med kommentar</option>';
                outputQuestion += '<option id="' + number + '" value="PICKER">Velger</option>';
                outputQuestion += '<option id="' + number + '" value="DATE">Dato/klokkeslett</option>';
            ...
            function selectChosen(nr){
                ...
                if(type == "TEXT"){
                    ...
                    function textChosen(nr){
                        ...
                        outputQuest1 += '<textarea rows="1" cols="30" placeholder="Svares kun med tekst slik som her"></textarea>';
                        outputQuest1 += '</div>';
                    ...
                    function ratingChosen(nr){
                        ...
                        outputQuest2 += '<p class="comment-check">Med kommentar<input id="commentCheck' + nr + '" class="day-checkbox" type="checkbox"></p>';
            ...
            function yesnoChosen(nr){
                ...
                outputQuest3 += '<h3 id="single">Nei</h3>';
                ...
                outputQuest3 += '</label>';
                outputQuest3 += '<h3 id="plural">Ja</h3>';
                outputQuest3 += '</div>';
                outputQuest3 += '</div>';
                ...
                $(whereAdd).html(outputQuest3); 
                    ...
                    function pickerChosen(nr){
                        ...
                        outputQuest4 += '<div class="add-alt" id="' + nr +'" onclick="addAlternativ(id)">';
                        outputQuest4 += '<i class="material-icons">add_circle</i>';
                        outputQuest4 += '<p>Legg til alternativ</p>';
                        outputQuest4 += '</div>';
                        ...
                        outputQuest4 += '<select>';
                        outputQuest4 += '<option id="' + number + '" name="TEXT" onclick="textChosen(id)">Alternativ 1</option>';
                        outputQuest4 += '<option id="' + number + '" name="SLIDER" onclick="ratingChosen(id)" >Alternativ 2</option>';
                        outputQuest4 += '<option id="' + number + '" name="COMMENT" onclick="yesnoChosen(id)">Etc.</option>';
                        outputQuest4 += '</select>';
                        outputQuest4 += '</div>';
            ...
            var outputRating = "";
                    ...
                    function showRatCom(nr){
                        ...
                        if(document.getElementById(comcheck).checked){
                            outputRating += '<textarea rows="1" cols="30" class="ratingText" placeholder="Her kan utøverne legge en kommentar"></textarea>';
                        }
            ...
            var outputTextArea = "";
                    ...
                    function yesChosen(nr){
                        ...
                        if(document.getElementById('yesnoCheck'+ nr).checked){
                            outputTextArea += '<textarea rows="1" cols="30" class="yesText" placeholder="Her kan utøverne legge en kommentar"></textarea>';
            ...
            function sendForm(){
                ...
                console.log(survDate);
                console.log(questionTypes);
                
                var createForm = Parse.Object.extend("data_" + klubbID + "_Survey");
                ...
                formCreate.save(null, {
                        success: function (formCreate) {
                            ...
                            if(survDate.getTime() === todayDate.getTime()){
                                ...
                                var setForm = Parse.Object.extend("data_" + klubbID + "_Surveys");
                                ...
                                formSet.save(null, {
                                    success: function(){
                                        console.log("Undersøkelse opprettet");
